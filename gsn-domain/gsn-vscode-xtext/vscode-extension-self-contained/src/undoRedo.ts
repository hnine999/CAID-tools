 ...
 */
export async function getUndoRedoEntry(modelDirUri: vscode.Uri, baseFiles: Map<string, string>, message: string): Promise<UndoRedoEntry> {
 ...
 */
export async function applyUndo(modelDirUri: vscode.Uri, undoRedoEntry: UndoRedoEntry): Promise<string[]> {
 ...
 */
export async function applyRedo(modelDirUri: vscode.Uri, undoRedoEntry: UndoRedoEntry): Promise<string[]> {
    const currentFiles = await readModelFiles(modelDirUri);
    if (currentFiles.size !== undoRedoEntry.fileInfos.size) {
